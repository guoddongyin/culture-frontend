    ...
    <div id="home">
        ...
        <div class="homeCenter">
            ...
            <div class="enrollText">
                <div>报名须知<i></i></div>
                <div @click="handleShow" class="iconfont icon-down"></div>
            </div>
            <div class="enrolltxt" v-if="!isShow">
                <div class="enrollContents" v-html="content.enrollRequire">
                </div>
            ...
            <div v-if="checkbox.length">
                ...
                <div id="logoInput" class="enrollTextCenter" style="background-color: #ffffff">
                    <div class="userInfoInput">
                        ...
                        <input v-model="username" :maxlength="49" @focus="pageToView" type="text" placeholder="请输入真实姓名">
                    </div>
                    <div class="userInfoInput">
                    ...
                    <!--<div style="display: none" class="userInfoInput">-->
                    ...
                    <div class="userInfoInput">
                        ...
                        <input v-model="phone" @focus="pageToView" type="tel" placeholder="请输入手机号" maxlength="11">
                    </div>
                    <div class="userInfoInput">
                        <div class="textName"><i style="color: red">*</i>验证码</div>
                        <div class="flexBettwens" style="width: 75%">
                            <input style="width: 2rem" @focus="pageToView" v-model.trim="code" type="tel" placeholder="请输入验证码">
...
<script>
    import { activities, sendmsg, activityEnroll } from '../../api/api'
...
//                this.$http.get(`/new/api/culture-app-gateway/user/sendmsg/${this.phone}?title=活动报名`).then(res => {
            ...
            handleGetCode() {
                ...
                if(this.phone===''){
                    ...
                    let title = '活动报名'
                    sendmsg(this.phone, title,4,this.$route.params.id).then(res => {
//                this.$http.get(`/new/api/culture-app-gateway/user/sendmsg/${this.phone}?title=活动报名`).then(res => {
                        console.log(res)
                        let _this = this;
                        _this.isSend = true;
            ...
            handleEnroll() {
                ...
                // 手机正则
                let pReg = /^1(3|4|5|6|7|8|9)\d{9}$/
	            //console.log(pReg.test(16825445455))
                if(this.username===''){
                    Toast('请输入姓名')
                    ...
                    activityEnroll(params).then(res => {
                        console.log(res)
                        Toast('提交成功，待管理员审核')
